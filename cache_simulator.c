...
typedef struct cache {
	char valor[32][MAX]; //segundo parâmetro é a quantidade de palavras que dá pra colocar no bloco 
...
int main(int argc, char const *argv[]){
	...
	int nsets, bsize, assoc, flag_saida,valores[MAX],j=0,tam=0, nindice, noffset, ntag, k, l, i, indicecache;
